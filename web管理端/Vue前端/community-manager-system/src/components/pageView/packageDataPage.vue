   ...
   <el-table
        ...
        >
            <template slot-scope="scope">
                {{scope.row.takeTime | myTimeMaker}}
            </template>
        </el-table-column>
        <el-table-column
        label="存件编号"
        ...
        >
        <template slot-scope="scope">
                {{scope.row.status | packageStatusStr}}
        </template>
        </el-table-column>
        <el-table-column
        label="取件时间"
        ...
        >
            <template slot-scope="scope">
                {{scope.row.scanTime | myTimeMaker}}
            </template>
        </el-table-column>
        <!-- <el-table-column
        label="操作"
        ...
        methods: {
         ...
         dataInit:function()
         {
           ...
           this.$axios(
               {
                   method:"post",
                   url:"/api/selectAllPackageRecord",
                   data:{
